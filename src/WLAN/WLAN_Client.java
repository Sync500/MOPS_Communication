...
public class WLAN_Client {
	...
	/**
	 * @description: send a blob of data. Sending may fail without notice or
	 *               with exception
	 * @param data
	 *            data to send
	 * @throws IOException
	...
	/**
	 * @description: send ByteArray to receiver check length of the array and
	 *               her IndexBound
	 * @param ByteArray
	 * @param start
	 *            point of array
	...
	/**
	 * @description: send a blob of data and block until success or failure is
	 *               signaled
	 * @param data
	 *            data to send
	 * @param timeout
	...
	/**
	 * @description: blocking read of data. Returns data in blobs as it was
	 *               sent! Use of Exception is implementation defined.
	...
	/**
	 * @description: check the state of the socket connection show state of the
	 *               connection
	 * @return boolean
	 */
